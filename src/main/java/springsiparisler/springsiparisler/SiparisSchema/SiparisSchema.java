package springsiparisler.springsiparisler.SiparisSchema;
...
public class SiparisSchema {
    ...
    public SiparisSchema() {

    }

    public SiparisSchema(int masaNo, UrunSchema[] urun, String[] ekstralar, String not, int toplamFiyat,
    ...
    public UrunSchema[] getUrun(String string, int i, String[] strings) {
        return urun;
    }

    public void setUrun(UrunSchema[] urun) {
        this.urun = urun;
    }
